<style>
	.module_title {
		background-color: #f1ea00 !important;
		text-align: center;
...
if ($module == 'dashboard' or $module == '') {
	...
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/ReplaceModule">
				<i class="menu-icon fa fa-rotate-right"></i>
				<span class="menu-text"> Replace Module </span>
			</a>
			<b class="arrow"></b>
		</li>
		...
		//) : ?>
			<li class="">
				...
				<ul class="submenu">
					...
					<?php //if (array_search("damageEntry", $access) > -1 || 
					//isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
					...
					<?php //if (array_search("damageList", $access) > -1 || 
					//isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("/service", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url();?>services">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> Services Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("serialHistory", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>serial_history">
					<i class="menu-icon fa fa-th-list"></i>
					<span class="menu-text"> Serial History </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		
		<?php if (array_search("productLedger", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>product_ledger">
					<i class="menu-icon fa fa-th-list"></i>
					<span class="menu-text"> Product Ledger </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		<?php if (array_search("/returnIemi", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url();?>returnIemi">
					<i class="menu-icon fa fa-usd"></i>
		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("servicesinvoice", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>servicesinvoice">
								<i class="menu-icon fa fa-caret-right"></i>
								Services Invoice
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("servicesinvoice", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>s_record">
								<i class="menu-icon fa fa-caret-right"></i>
								Services Record
							</a>
							<b class="arrow"></b>
...
<?php } elseif ($module == 'PurchaseModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("purchaseReturns", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>purchaseReturnsImei">
					<i class="menu-icon fa fa-rotate-right"></i>
		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("supplier_payment_history", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>supplier_payment_history">
								<i class="menu-icon fa fa-caret-right"></i>
...
<?php } elseif ($module == 'HRPayroll') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("salarypayment", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>salarypayment">
					<i class="menu-icon fa fa-money"></i>
		...
		<?php if (array_search("emplists", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>emplists">
		...
		<?php if (array_search("emplists", $access) > -1 
			|| array_search("employeesalaryreport", $access) > -1 
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
					<i class="menu-icon fa fa-file"></i>
				...
				<ul class="submenu">
					...
					<?php if (array_search("employeesalaryreport", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>employeesalaryreport">
								<i class="menu-icon fa fa-caret-right"></i>
...
<?php } elseif ($module == 'ReplaceModule') { ?>
	...
	<ul class="nav nav-list">
		...
		<li>
			<a href="<?php echo base_url(); ?>module/ReplaceModule" class="module_title">
				<span>Replace Module</span>
			</a>
		</li>

		<?php if (array_search("sale_replace", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>sale_replace">
					<i class="menu-icon fa fa-medkit"></i>
					<span class="menu-text"> Replace  Entry</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("replace_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>replace_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text">Replace Record</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("purchase_replace", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>purchase_replace">
					<i class="menu-icon fa fa-plus"></i>
					<span class="menu-text"> Purchase  Replace</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("purchase_replace_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>purchase_replace_record">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text">Pur. Replace Record</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
