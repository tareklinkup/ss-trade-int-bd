            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong>Payment Type:</strong> {{ sales.payment_type }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <br>(<span  v-for="(Serial, ind) in product.serial.filter(sl => sl.sales_details_id == product.SaleDetails_SlNo) ">
                                        {{Serial.ps_serial_number}} <span>,</span>
                                        </span>)
                                    </td>
				...
				printWindow.document.write(`
                    ...
                    <body>
                        ...
                        <div class="container" style="position:fixed;bottom:15px;width:100%;">
                             <div style="margin-bottom:20px;padding-bottom:6px;text-align:center; font-size:16px !important;">
                                   <p>15 يومًا للاستبدال ولكن لا تقبل في حالة كسر الختم ، يجب الحذر من العبوة المختومة</p>
                                   <p>15 Days Exchange but do not accept if seal is broken caution sealed package</p>
                            </div>
