				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="date" class="form-control" v-model="payment.CPayment_date" required @change="getCustomerPayments">
							</div>
						</div>
						<div class="form-group">
			...
			<div class="table-responsive">
				...
				<table>
					  <tr>
						 ...
						 <td></td>
						 <td>Total : </td>
						 <td> {{payments.reduce((prev,cur)=>{
				                  return prev+parseFloat(cur.CPayment_amount)},0).toFixed(2) }}</td>
						 <td></td>
					  </tr>
				</table>
