...
<div class="col-md-12">
<div  class="col-md-5">
<h4><a style="cursor:pointer" onclick="printContent('printPage')"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a></h4>
</div>
<?php 
	$branch = $this->db->query("SELECT * FROM tbl_brunch where status = 'a' order by Brunch_name asc ")->result();
?>

<div class="col-md-2" style="background: #fff; padding: 5px;">
	<form id="SearchForm" method="post">
		<select name="branch" class="form-control" onchange="BranchWiseBalanceSheet(this.value)">
			<option value="All">Select a Branch</option>
			<option value="All">All</option>
			<?php foreach($branch as $b): ?>
				<option value="<?php echo $b->brunch_id; ?>">
					<?php echo $b->Brunch_name; ?>
				</option>
			<?php endforeach; ?>
		</select>
	</form>
...
<script type="text/javascript">
	function BranchWiseBalanceSheet(id)
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>BalanceSheetReportBranch/"+id,
