    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="serialHistory" v-model="access"> Serial History</li>
                    <li><input type="checkbox" class="access" value="productLedger" v-model="access"> Product Ledger</li>
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="supplier_payment_history" v-model="access"> Supplier Payment History</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accountsReports">
                    ...
                    <li><input type="checkbox" class="access" value="BalanceSheet" v-model="access"> Balance Sheet</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="hrPayroll">
                    <li><input type="checkbox" class="access" value="salarypayment" v-model="access"> Salary Payment</li>
                    ...
                    <li><input type="checkbox" class="access" value="employeesalaryreport" v-model="access"> Employee Payment Report</li>
                </ul>
            </div>
            <div class="group">
                <input type="checkbox" id="replaces" class="group-head" @click="onClickGroupHeads"> <strong>Replace Module</strong>
                <ul ref="replaces">
                    <li><input type="checkbox" class="access" value="sale_replace" v-model="access"> Replace Entry</li>
                    <li><input type="checkbox" class="access" value="replace_record" v-model="access"> Replace Record</li>
                    <li><input type="checkbox" class="access" value="purchase_replace" v-model="access"> Purchase Replace</li>
                    <li><input type="checkbox" class="access" value="purchase_replace_record" v-model="access"> Purchase Replace Record</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
