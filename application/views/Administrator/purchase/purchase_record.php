	...
	<div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'quantity' && suppliers.length > 0 ? '' : 'none'}">
				...
				<div class="form-group" v-bind:style="{display: searchType == '' || searchType == 'user' ? '' : 'none'}">
	...
	<div class="row" style="margin-top:15px;display:none;" v-bind:style="{display: purchases.length > 0 ? '' : 'none'}">
		...
		<div class="col-md-12">
			<div class="table-responsive" id="reportContent">
					...
					<tbody>
						<template v-for="purchase in purchases">
							<tr>
								...
								<td style="text-align:center;">{{ purchase.purchaseDetails[0].PurchaseDetails_Discount }}</td>
				...
				<table 
					class="record-table" 
					v-if="(searchType == '' || searchType == 'user') && recordType == 'without_details'" 
					style="display:none" 
					v-bind:style="{display: (searchType == '' || searchType == 'user') && recordType == 'without_details' ? '' : 'none'}"
					>
					<thead>
						<tr>
							<th>Invoice No.</th>
