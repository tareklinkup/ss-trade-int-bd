				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="date" class="form-control" required v-model="transaction.Tr_date" @change="getTransactions">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control" required v-model="transaction.In_Amount" 
									style="display:none;" 
									v-if="transaction.Tr_Type == 'In Cash'"
									v-bind:style="{display: transaction.Tr_Type == 'In Cash' ? '' : 'none'}"
								>
								<input type="number" class="form-control" required v-model="transaction.Out_Amount" 
		...
		<div class="col-md-12">
			<div class="table-responsive">
				...
				<table> 
				   ...
				   <td></td>
				   <td></td>
				   <td> Total Received Amount  : {{transactions.reduce((prev,cur)=>{
				                  return prev+parseFloat(cur.In_Amount)},0) }} </td>
				   <td></td>
				   <td></td>
				   <td></td>
				   <td> ------Total Paid Amount  : {{transactions.reduce((prev,cur)=>{
				                  return prev+parseFloat(cur.Out_Amount)},0) }}</td>
				</table>
