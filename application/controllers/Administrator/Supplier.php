 ...
 public function getSupplierLedger(){
    ...
    public function getSupplierPayments(){
        ...
        if(isset($data->supplierId) && $data->supplierId != ''){
            $supplierClause = " and sp.SPayment_customerID = $data->supplierId";
        }
        ...
        $payments = $this->db->query("
            ...
            and sp.SPayment_brunchid = ? $paymentTypeClause $dateClause $supplierClause
    ...
    public function supplierPaymentHistory() {
        ...
        $data['title'] = "Supplier Payment History";
        $data['content'] = $this->load->view('Administrator/reports/supplier_payment_history', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
}