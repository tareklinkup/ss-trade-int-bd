				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control" v-model="supplierDue">
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="date" class="form-control" v-model="payment.SPayment_date" required @change="getSupplierPayments">
							</div>
						</div>
						<div class="form-group">
