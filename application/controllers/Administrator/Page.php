...
class Page extends CI_Controller {
    ...
    public function getCategories(){
        $categories = $this->db->query("
            ...
            where status = 'a' and category_branchid = ?
    ...
    public function add_category()  {
        ...
        $data['parent_categories'] = $this->db->query("select * from tbl_productcategory where status = 'a'")->result();
    ...
    public function insert_category()  {
        ...
        try {
    		...
    		$brunch = $this->brunch;
            $query = $this->db->query("select * from tbl_productcategory where category_branchid = '$brunch' and ProductCategory_Name = '$catname' and status = 'a'");
            ...
            $res->success = false;
            $res->message = 'Failed..!'. $ex->getMessage();
        }
    ...
    public function catupdate(){
        ...
        try {
            ...
            $catname = $this->input->post('catname');
            $brunch = $this->brunch;
            $query = $this->db->query("select * from tbl_productcategory where category_branchid = '$brunch' and ProductCategory_Name = '$catname' and ProductCategory_SlNo != '$id' and status = 'a'");
