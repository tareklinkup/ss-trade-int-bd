...
$route['Serial_number_exist_check'] = 'Administrator/Services/SerialNumberExistCheck';
$route['add_services'] = 'Administrator/Services/addServices';

$route['get_serial_list'] = 'Administrator/sales/serialList';
$route['get_serial_report'] = 'Administrator/sales/get_serial_report';

$route['serial_history'] = 'Administrator/sales/serialHistory';

$route['update_services'] = 'Administrator/Services/update_services';
$route['s_record'] = 'Administrator/Services/s_record';
$route['service_record'] = 'Administrator/Services/service_record';
$route['service_record_delete'] = 'Administrator/Services/service_record_delete';
...
$route['check_serial_number'] = 'Administrator/Products/checkImeiNumber';
...
$route['SerialWiseCustomer'] = 'Administrator/Products/SerialWiseCustomer';
...
$route['get_sales_serial'] = 'Administrator/Products/getSaleSerials';
$route['get_replace_serial'] = 'Administrator/Products/getSaleSerialReplace';
...
// all branch product stock
$route['branch_product'] = 'Administrator/Products/allBranchProductStock';
$route['get_all_branch_stock']	=	'Administrator/Products/getAllBranchProductStock';
...
$route['check_soldSerial'] = 'Administrator/Purchase/check_soldSerial';
...
$route['remove_cart_serial'] = 'Administrator/Sales/remove_cart_serial';
...
$route['get_purchases_serial'] = 'Administrator/Purchase/getPurchasesImei';
...
$route['supplier_payment_history'] = 'Administrator/Supplier/supplierPaymentHistory';
...
$route['GetSerialList']          = 'Administrator/Sales/GetSerialList';
$route['GetSerialListService']          = 'Administrator/Sales/GetSerialListService';
$route['GetServiceStatus']          = 'Administrator/Sales/GetServiceStatus';
$route['purchaseReturnsImei']  = 'Administrator/Purchase/returnsIemi';
$route['returnIemi']  = 'Administrator/Sales/returnIemi';
$route['get_return_serial_number']  = 'Administrator/Sales/get_return_serial_number';
$route['purchase_serial_return']  = 'Administrator/Purchase/purchase_serial_return';
$route['sale_serial_return']  = 'Administrator/Sales/sale_serial_return';
...
$route['servicesinvoice'] = 'Administrator/Services/services_invoice';
...
$route['servicesinvoices'] = 'Administrator/Services/services_invoices';
...
$route['branchwise_sales']	=	'Administrator/Sales/branchwiseProductSale';
...
$route['delete_serials'] = 'Administrator/Purchase/delete_serials';
...
$route['sales_graph_data'] = 'Administrator/Graph/salesGraphData';
$route['get_top_products'] = 'Administrator/Graph/getTopProducts';
$route['get_top_customers'] = 'Administrator/Graph/getTopCustomers';
...
// Sales Replace
$route['sale_replace'] = 'Administrator/Replaces';
$route['add_replace'] = 'Administrator/Replaces/addReplace';
$route['replace_record'] = 'Administrator/Replaces/replaceRecord';
$route['get_replace_record'] = 'Administrator/Replaces/getReplaceRecord';
$route['replace_invoice/(:any)'] = 'Administrator/Replaces/replaceInvoice/$1';

// Purchase replace
$route['purchase_replace'] = 'Administrator/Replaces/purchaseReplace';
$route['add_purchae_replace'] = 'Administrator/Replaces/addPurchaseReplace';
$route['purchase_replace_record'] = 'Administrator/Replaces/purchaseReplaceRecord';
$route['get_purchase_replaces'] = 'Administrator/Replaces/getPurchaseReplaceRecord';
$route['purchase_replace_invoice/(:any)'] = 'Administrator/Replaces/purchaseReplaceInvoice/$1';