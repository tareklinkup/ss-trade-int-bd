					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							...
							<span style="font-weight: bold; color: #972366; font-size: 16px;">
								<?php $branch_logo =base_url().'uploads/company_profile_org/'.$companyInfo->Company_Logo_thum; ?>
								<img src="<?= $branch_logo ?>" alt="<?php echo $this->session->userdata('Brunch_name');  ?>" style="height: 30px; width: 50px;">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							Developed by <span class="blue bolder"><a href="http://linktechbd.com/" target="_blank">Link Up Technology</a></span>
						</span>
