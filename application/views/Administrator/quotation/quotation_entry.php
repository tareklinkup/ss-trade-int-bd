	...
	<div class="col-xs-9 col-md-9 col-lg-9">
					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group clearfix">
								...
								<div class="col-sm-8">
								<v-select v-bind:options="customers" v-model="selectedCustomer" label="Customer_Name" v-on:input="customerOnChange"></v-select>
								</div>
							</div>
							<div class="form-group clearfix">
								<label class="col-sm-4 control-label no-padding-right"> Customer</label>
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group" style="display:none"> 
									<label class="col-sm-3 control-label no-padding-right"> Discount </label> <!-- Hide Discount -->
									<div class="col-sm-9">
										<input type="number" id="quantity" placeholder="discount" class="form-control" v-model="selectedProduct.discount" v-on:input="productTotal" autocomplete="off" required/>
									</div>
								</div>
		...
		<div class="col-xs-12 col-md-12 col-lg-12" style="padding-left: 0px;padding-right: 0px;">
			<div class="table-responsive">
				...
				<textarea class="form-control" id="" rows="3" v-model="quotation.note">
						...
						<div class="col-sm-12">
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr style="display:none"> <!-- Hide Discount -->
										<td>
											<div class="form-group">
...
<script>
	...
	new Vue({
		...
		methods:{
			...
			customerOnChange(){
				this.quotation.customerName   = this.selectedCustomer.Customer_Name
				this.quotation.customerMobile = this.selectedCustomer.Customer_Mobile
				this.quotation.customerAddress = this.selectedCustomer.Customer_Address
			},
			getBranches(){
			...
			productTotal(){
				...
				var numVal1 = (parseFloat(this.selectedProduct.quantity) * parseFloat(this.selectedProduct.Product_SellingPrice)).toFixed(2);
